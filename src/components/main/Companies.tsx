...
import Bgiamge from "./componentsbgimage/Bgiamge";
...
export default function Companies() {
  return (
    <div className="relative w-full h-150">
      ...
      <div className="swiper-container px-4 w-105 md:w-full mx-auto  relative z-10">
        <Swiper
          modules={[Autoplay]}
          spaceBetween={20}
          slidesPerView={"auto"}
        ...
        >
          {companies.map((company, i) => (
            <SwiperSlide key={i} className="!w-[280px] flex justify-center">
              <div className="md:max-w-full rounded-xl shadow-lg overflow-hidden flex flex-col bg-white ">
                <Image
                  width={360}
                  height={180}
                  src={company.image}
