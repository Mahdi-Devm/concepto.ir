  ...
  return (
    <div className="flex gap-4 justify-center">
      {companies.map((company, i) => (
        <VanillaTiltcard key={i}>
          <div
            key={i}
            className="rounded-xl shadow-lg h-[450px] w-[300px] overflow-hidden flex flex-col"
          >
            <Image
              width={360}
              height={180}
            ...
            <div className="p-4 flex flex-col justify-between ">
              ...
              <p className="text-sm mb-1 line-clamp-2">{company.description}</p>
              <div className="flex gap-2 mt-5">
                <div className="flex items-center gap-1 text-yellow-500 mb-1 ">
                  ...
                  {company.stars % 1 !== 0 && <FaStar className="opacity-50" />}
